...
public class DTExpandedEcosphereGenFeatures {
    ...
    public static final GenFeature BUTTRESS_ROOT = new ButtressRootsGenFeature(DynamicTreesExpandedEcosphere.location("buttress_root"));
    ...
    public static void registerGenFeatures(RegistryEvent<GenFeature> event) {
        event.getRegistry().registerAll(COBWEB, REPLACE_GRASS, MOSS, FILL_VOLUME, BUTTRESS_ROOT);
    }
}
