...
public class RegisterJSONAppliers {
    ...
    public static int getMaxGrowthHeight(Species species) {
        ...
        return maxGrowHeightTreeMap.getOrDefault(path, 999);
    }

    @SubscribeEvent(priority = EventPriority.HIGHEST)
    public static void registerAppliersFamily(final ApplierRegistryEvent.Load<Family, JsonElement> event) {
    ...
    public static void registerFamilyAppliers(PropertyAppliers<Family, JsonElement> appliers) {
        appliers.register("generate_buttress_root", Boolean.class, ButtressRootBlockSupplier::familyHasRootGen);
    }
