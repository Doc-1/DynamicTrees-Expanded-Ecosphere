package net.docvin.dt_expandedecosphere.client.model.baked;
...
public class ButtressRootBlockBakedModel implements IDynamicBakedModel {
    ...
    public ButtressRootBlockBakedModel(ResourceLocation modelLocation, ResourceLocation barkTextureLocation, @NotNull Function<Material, TextureAtlasSprite> spriteGetter) {
    ...
    public BakedModel bakeSleeve(int radius, @NotNull Direction dir) {
        ...
        Vector3f posTo = new Vector3f((float) (centerX + halfSizeX) / 2, radialHeight, (float) (centerZ + halfSizeZ) / 2);
    ...
    public ModelData getModelData(@Nonnull BlockAndTintGetter world, @Nonnull BlockPos pos, @Nonnull BlockState state, @Nonnull ModelData tileData) {
        RootConnections rootConnections = state.getBlock() instanceof ButtressRootBlock buttressRootBlock
                ? new RootConnections(buttressRootBlock.getConnectionData(world, pos))
                : new RootConnections();
    ...
    protected int getRadius(BlockState blockState) {
        ...
        return ((ButtressRootBlock) blockState.getBlock()).getSize(blockState);
    }
